...
| `BACKEND_FINDINGS_2_DAHANI.md` | Second round sent 2026-09-23 (backend @ `21b9a1b`): cross-tenant write, password hashes in responses, bcrypt-on-tokens, plus what the AI layer still needs |
