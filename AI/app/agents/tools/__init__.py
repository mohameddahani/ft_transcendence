"""Tool definitions bound to a verified Scope (task 2.1).
    ...
    tools = build_staff_tools(ctx.scope)      # gym employee: the same, minus money
...
from app.agents.tools.admin import build_admin_tools, build_staff_tools
...
__all__ = ["Tool", "build_admin_tools", "build_member_tools", "build_staff_tools",
           "period_start", "period_window",
